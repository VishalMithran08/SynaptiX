...
def main() -> int:
    ...
    print("  PSNR   28.9058 dB      (per-image, then averaged)")
    print("  SSIM   0.793831")
    print("  LPIPS  0.311227")
    print("  hard subset (160 images):  30.2194 dB / 0.838477")
    print("  (default 4-view TTA; 8 views gives 28.9711 dB at 2x the time)")
    print()
    print("  Per-image PSNR spans 11.68 - 43.39 dB across the set:")
